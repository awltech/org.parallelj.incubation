...
public class NewTableforProcedureinDetail {
	ComputedColumn cs5, cs6, cs7, cs8 = null;
	PropertyHandle computedSet =null;

	public NewTableforProcedureinDetail(ComputedColumn cs5, ComputedColumn cs6, ComputedColumn cs7,
	...
	public TableHandle createMyTable(ElementFactory designFactory,String dataset,int m) throws SemanticException{
		...
		mappingColonne.put("elementidmeaning_p"+m, "ElementIDMeaning");
		mappingColonne.put("endtoend_p"+m+"", "EndTOEnd");
		mappingColonne.put("createtostart_p"+m, "CreateTOStart");
		mappingColonne.put("starttoend_p"+m, "StartTOEnd");
		...
		cs5.setExpression( "dataSetRow[\"elementidmeaning_p"+m+"\"]" );
		computedSet.addItem( cs5 );
		cs6.setExpression( "dataSetRow[\"endtoend_p"+m+"\"]" );
		computedSet.addItem( cs6 );
		cs7.setExpression( "dataSetRow[\"createtostart_p"+m+"\"]" );
		computedSet.addItem( cs7 );
		cs8.setExpression( "dataSetRow[\"starttoend_p"+m+"\"]" );
